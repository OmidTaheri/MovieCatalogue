...
public class SearchRecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public SearchRecyclerAdapter(List<Movie> list, Context mContext, MyGridAutofitLayoutManager Manager) {
        this.list = list;
    ...
    public interface Callback {
        ...
        void retryPageLoad(String query, int page);
    }
    ...
    */
    ...
    public void showRetry(boolean show, @Nullable String errorMsg, String query, int page) {
